/**
 * 公有领域《周易》原文以 Wikisource 六十四卦页及《系辞上》核对。
 * bits 与 lines 均按自下而上（初爻至上爻）保存。
 */
const DATA = [
  {
    "number": 1,
  ...
  },
  {
    ...
    "judgement": "坤。元亨，利牝马之贞。君子有攸往，先迷后得主。利西南得朋，东北丧朋。安贞吉。",
    "yao": [
      "初六。履霜，坚冰至。",
      "六二。直方大，不习无不利。",
      "六三。含章可贞。或从王事，无成有终。",
...
export const HEXAGRAMS = Object.fromEntries(
